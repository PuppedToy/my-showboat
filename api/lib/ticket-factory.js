...
TicketFactory.prototype.add_ticket = function(name, user_id) {

	var ticket = this.get_ticket(name, "name");
	if(!ticket) {
		ticket = new Ticket(name, this.generate_id(), user_id);
...
TicketFactory.prototype.remove_ticket = function(id, search_by) {
